#
#  Be sure to run `pod spec lint PayBoxSdk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Arman Mergenbayev"
  # s.authors            = { "Arman Mergenbayev" => "am@paybox.money" }
  # s.social_media_url   = "http://twitter.com/Arman Mergenbayev"
  ...
  s.source       = { :git => "http://arman88@gitlab.local/arman88/paybox_sdk_ios.git", :tag => "#{s.version}" }
